...
<h2><?php echo $this->lang->line('txt_step_2').' - '.$this->lang->line('txt_image_selection'); ?></h2><br/>
<?php echo form_open_multipart('coupon/uploadImages',array('id' => 'fileupload')); ?>
    ...
    <center>
        <?php 
			echo anchor('coupon/edit/'.$coupon,$this->lang->line('txt_go_back'),array('class' => 'btn','style' => 'margin-right:5px;')); 
			echo anchor('admin/','<i class="icon icon-ok"></i>'.' '.$this->lang->line('txt_finish'),array('class' => 'btn-black','style' => 'margin-right:5px;')); 
		?>        
    </center>
<?php echo form_close(); ?>
