...
<table>
    <tr>
        ...
        <td><?php echo form_input('start_date',$academic_history[start_date]); ?></td>
    ...
    <tr>
        ...
        <td><?php echo form_input('end_date',$academic_history[end_date]); ?></td>
    </tr>
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_school')); ?>
        </td>
        <td><?php echo form_dropdown('school',$schools,$academic_history[school]); ?></td>
        <td class="required"></td>
    </tr>
    <tr>
        <td>
        ...
        <td><?php echo form_dropdown('academic_level',$academic_levels,$academic_history[academic_level]); ?></td>
        <td class="required"></td>
    </tr>
    <tr>
        <td>
        ...
        <td><?php echo form_dropdown('academic_major',$academic_historys,$academic_history[academic_major]); ?></td>
        <td class="required"></td>
    </tr>
    <tr>
        <td>
        ...
        <td><?php echo form_input('speciality',$academic_history[speciality]); ?></td>
    </tr>
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_completed_years')); ?>
        </td>
        <td><?php echo form_input('completed_years',$academic_history[completed_years]); ?></td>
    </tr>
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_title_years')); ?>
        </td>
        <td><?php echo form_input('title_years',$academic_history[title_years]); ?></td>
    </tr>
    <tr>
        <td colspan="2"><br/>
