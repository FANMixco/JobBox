...
<table>
    ...
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_start_position')); ?>
        </td>
        <td><?php echo form_input('start_position',$this->input->post('start_position')); ?></td>
    </tr>
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_end_position')); ?>
        </td>
        <td><?php echo form_input('end_position',$this->input->post('end_position')); ?></td>
    </tr>
    <tr>
        <td>
