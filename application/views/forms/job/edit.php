...
<table>
    <tr>
        ...
        <td class="required"><?php echo form_input('position_name',$job[position_name]); ?></td>
		<td class="tright">
            <?php echo form_label($this->lang->line('lbl_country')); ?>
        </td>
        <td><?php echo form_dropdown('country',$countries,$job[country],'id="country"'); ?></td>
    </tr>      
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_end_date')); ?>
        </td>
        <td class="required"><?php echo form_input('end_date',$job[end_date], 'id="datepicker"'); ?></td>
		<td class="tright">
	...
	<tr>
        ...
        <td colspan="3"><?php echo form_textarea('description',$job[description]); ?></td>
    </tr> 
    <tr>
        <td>
            <?php echo form_label($this->lang->line('lbl_requirements')); ?>
        </td>
        <td colspan="3"><?php echo form_textarea('requirements',$job[requirements],array('id' => 'posRequirements','name' => 'posRequirements')); ?></td>
    </tr>    
    <tr>
        <td colspan="4"><br/>
